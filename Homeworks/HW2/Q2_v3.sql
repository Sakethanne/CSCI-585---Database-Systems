 ...
 * Step 3: JOIN CLAUSE: we join the creators.userid with the channels.userid to connect the channel names owned by a particular user. We then join the creators table with the users table on the condition that creators.userid = users.userid 
 * 						Then lastly, we join the vedios table with the channels table based on the videos.channelid = channels.channelid.
